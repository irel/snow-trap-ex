...
[locate x=95 y=325][ch text=&tf.wudi cond="checkdata((f.当前load页-1)*8)==true"][resetfont]
...
[locate x=77 y=158][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8"]
[locate x=364 y=158][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+1"]
[locate x=650 y=158][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+2"]
[locate x=937 y=159][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+3"]
[locate x=77 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+4"]
[locate x=364 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+5"]
[locate x=650 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+6"]
[locate x=937 y=370][button normal="kuang1" over="kuang2" storage="load2.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+7"]
...
[询问窗口 text=&tf.询问对话 storage=load2.ks cancel=*cancel ok=*确定读取 xuanxiang=cdjm2]
[endif]
