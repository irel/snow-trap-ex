...
[backlay]
[layopt layer=message2 visible=true page=back]
[position layer=message1 page=back visible=true opacity=255 top=531 height=720 left=79 width=1280 marginl=240 margint=22 marginr=270 marginb=0 frame="duihuakuang.png"]
[current layer=message1 page=fore]
[er]
[stoptrans]
[trans method=crossfade time=%t|200][wt]
@endmacro
;例：[显示文字框2]或者[显示文字框2 t=200]

;3.5、显示小头像
@macro name=显示小头像
[backlay]
[position layer=message10 page=back visible=true opacity=255 top=%top|531 height=720 left=%left|79 width=1280 frame=%f]
[layopt layer=message10 page=back visible=true index=1002500]
[er]
[stoptrans]
[trans method=crossfade time=%t|200][wt]
@endmacro
;[显示小头像 f="ghfputong2xiao" top=490 left=70 t="100"]

;3.5、小头像消失
@macro name=小头像消失
[backlay]
[position layer=message10 page=back visible=true opacity=255 top=%top|531 height=720 left=%left|79 width=1280 frame="wenzikuangdiban.png"]
[layopt layer=10 index=1002500]
[stoptrans]
[trans method=crossfade time=%t|200][wt]
@endmacro
;例：[小头像消失 t=100]
...
;文字框
[layopt layer=message2 visible=true page=back]
[position layer=message1 page=back visible=true opacity=255 top=531 height=720 left=79 width=1280 marginl=100 margint=22 marginr=53 marginb=0 frame="duihuakuang.png"]
[current layer=message1 page=fore]
[stoptrans]
[trans method=crossfade time=%t|100][wt]
[endmacro]
...
@macro name=全屏文字框
[backlay]
[position layer=message2 page=back frame="quanpingwenzikuangdiban.png" top="650" left="475" height="200" weight="200" visible=true opacity=255 ]
[current layer=message2 page=back][er]
[sysbutton name="save" normal="saveb1.png" over="saveb2.png" enterse="yidong" clickse="dianji" x=8 y=6  exp="kag.callExtraConductor('save.ks', '*save')"  entersebuf=3  clicksebuf=3 ]
[sysbutton name="load" normal="loadb1.png" over="loadb2.png" enterse="yidong" clickse="dianji"  x=99 y=6  exp="kag.callExtraConductor('load.ks', '*load')"  entersebuf=3 clicksebuf=3 ]
[sysbutton name="note"  normal="noteb1.png" over="noteb2.png" enterse="yidong" clickse="dianji" x=200 y=6  exp="kag.callExtraConductor('note.ks', '*note')" entersebuf=3  clicksebuf=3 ]
[sysbutton name="config" normal="configb1.png" over="configb2.png" enterse="yidong" clickse="dianji" x=295 y=6 exp="kag.callExtraConductor('shezhi.ks', '*shezhi')"  entersebuf=3  clicksebuf=3 ]
[sysbutton name="log"  exp="kag.onShowHistoryMenuItemClick()" normal="logb1.png" over="logb2.png" enterse="yidong" clickse="dianji" x=414 y=6   entersebuf=3  clicksebuf=3 ]
[sysbutton name="auto" normal="autob1.png" over="autob2.png" enterse="yidong" clickse="dianji" x=535 y=6 exp="kag.onAutoModeMenuItemClick()"  entersebuf=3  clicksebuf=3 ]

[sysbutton name="skip" normal="skipb1.png" over="skipb2.png" enterse="yidong" clickse="dianji" x=635 y=6 exp="kag.onSkipToNextStopMenuItemClick()"  entersebuf=3  clicksebuf=3 ]

;[rclick call=true target=*youjianquanping enabled=true storage="openx3.ks"]

[layopt layer=message2 visible=true page=back]
[position layer=message1 page=back visible=true opacity=255 top=66 height=570 left=58 width=760 marginl=60 margint=45 marginr=24 marginb=30 frame=quanpingwenzikuang.png  marginl=150 margint=100 marginr=120]
[current layer=message1 page=fore]
[stoptrans]
...
[position layer=message7 left=0 top=0  width=424 height=201 opacity=255 visible=true page=back frame="%xuanxiang"]
...
;显示询问窗口
[backlay]
[position layer=message7 left=0 top=0  width=424 height=201 opacity=255 visible=true page=fore frame="%xuanxiang"]
...
class HttpCounter extends HttpRequest
{
	function HttpCounter(win)
	{
	super.HttpRequest(win);
	}
	...
	function sendCountData(method, url)
	{
		try {
			open(method, url);
			send();
			dm("Count Data Request Sended");
		} catch(e) {
			dm("Count Data Request Error!\n" + e.message);
		}
	}
	...
	function onReadyStateChange(readyState)
	{
		try {
			...
			{
				dm("Count Data Response Received:");
				dm(getResponseText());
			}
		} catch(e) {
			dm("Count Data Response Receive Error!\n" + e.message);
			}
	}
}
...
// config参数处理用的插件
class ConfigPlugin extends KAGPlugin
{
var httpCounter = void;
	function ConfigPlugin()
	{
	super.KAGPlugin();
	
	httpCounter = new HttpCounter(kag);
	}

	function finalize()
	{
	invalidate httpCounter if httpCounter !== void;
	...
	{
		if(stable && kag.current.buttons.skip !== void) {
		kag.current.buttons.skip.loadButtons("SKIP_N", "SKIP_O");
		kag.current.buttons.auto.loadButtons("AUTO_N", "AUTO_O");
		}
	}
}

kag.addPlugin(global.configPlugin = new ConfigPlugin());
...
[locate x=455 y=214][emb exp="mp.sele1"]
[locate x=455 y=264][emb exp="mp.sele2"]
[locate x=455 y=313 cond="mp.sele3 != void"][emb exp="mp.sele3" cond="mp.sele3 != void"]

[position layer=message3  top=0 height=720 left=0 width=1280 marginl=0 margint=0 marginr=0 marginb=0 opacity=0 page=fore visible=true]
